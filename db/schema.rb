...
ActiveRecord::Schema.define(:version => 20130214193021) do
  ...
  create_table "displasia", :force => true do |t|
    ...
    t.string   "reformateo"
    t.text     "discircunvolucion",          :limit => 255
    t.string   "dislobulo"
    ...
    t.string   "dishemisferio3"
    t.string   "dishemisferio4"
  end
  ...
  create_table "malformacions", :force => true do |t|
    ...
    t.string   "hemisferio3"
    t.string   "hemisferio4"
  end
